...
exports.addProduct = async (req, res) => {
    ...
    try {
        ...
        const data = await db.query('INSERT INTO food_products(title, proteins, carbs, fat, category, sub_category, food_type, intolerance) values($1, $2, $3, $4, $5, $6, $7, $8) RETURNING id;', [title, proteins, carbs, fat, category, sub_category, food_type, intolerance]);
